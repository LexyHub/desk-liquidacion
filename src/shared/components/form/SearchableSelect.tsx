  ...
  return (
    <Popover open={open} onOpenChange={setOpen}>
      ...
      <PopoverContent
        align='start'
        className={cn(
          "p-0 mt-1 min-w-[var(--radix-popover-trigger-width)] w-[var(--radix-popover-trigger-width)]",
          popupClassName
        )}>
            ...
            <CommandGroup>
              {filteredOptions.map((option, i) => (
                <CommandItem
                  ...
                  className={clsx(
                    "flex items-center px-4 font-normal text-base cursor-pointer data-[highlighted]:bg-[#E4E1FF] hover:bg-[#E4E1FF] data-[highlighted]:text-[#666] data-[highlighted]:font-normal data-[selected=true]:bg-[#E4E1FF] data-[selected=true]:text-[#666] rounded-xs text-[#666] transition-all",
                    {
                      "bg-[#E4E1FF]": value === option.value,
